...
import id.aashari.code.miband2.Helpers.DatabaseHelper;
...
public class MainActivity extends Activity {
    ...
    DatabaseHelper myDb;
    Button btnStartConnecting, btnGetBatteryInfo, btnGetHeartRate, btnWalkingInfo, btnStartVibrate, btnStopVibrate , btnStartCycle;
    ...
    void initilaizeComponents() {
        ...
        btnStartCycle = (Button) findViewById(R.id.startCycle);
    }
    ...
    void initializeEvents() {
        ...
        btnStartCycle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startCycle();
            }
    ...
    final BluetoothGattCallback bluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Log.d("Rate", "HeartRate __________________________ " + txtByte.getText());
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            Log.d("Rate", "write __________________________ " + txtByte.getText());
        }
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            byte[] data = characteristic.getValue();
            byte parsedData = data[1];
            txtByte.setText(Byte.toString(parsedData));
            Log.d("Rate", "changed __________________________ " + txtByte.getText());
    ...
    //toDo parse data to Db 

    public void addDataToDatabase(byte heartRate){
        boolean isInserted = myDb.insertData(Byte.toString(heartRate) ,editDescription.getText().toString(), editPrice.getText().toString() , getDate());
